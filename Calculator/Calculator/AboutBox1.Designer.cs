namespace Calculator
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Калькулятор дробей на С#";
            ...
            this.labelCopyright.Text = "Автор: Андрей Балашов";
            ...
            this.labelCompanyName.Text = "OOO \"LevCO\"";
            ...
            this.textBoxDescription.Text = "Данная программа предназначена для проведения различных арифметических операций н" +
    "ад дробями";
